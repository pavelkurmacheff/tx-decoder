import { BlockchainRpcCaller } from '../../uniswap-v3/model/common.model';
// import { TxConfirmDataBuilder } from '../../../tx-confirm-data.builder';
import { TOKENS_MOCK } from '../../../__tests__/mocks/tokens.mock';
import { TOKEN_PRICES_MOCK } from '../../../__tests__/mocks/token-prices.mock';
...
describe('Transaction data for confirmation builder', () => {
    ...
    it('Approve transaction', async () => {
        const txConfig: TransactionRaw = {
            nonce: 383,
            gasPrice: BigNumber.from('0x1da4f97c6e'),
            gasLimit: BigNumber.from('0x011150'),
    ...
    it('Swap transaction: swap()', async () => {
        ...
        const txConfig: Transaction = {
            nonce: 194,
            gasPrice: BigNumber.from('0x1b7b430f2c'),
            gasLimit: BigNumber.from('0x091d06'),
    ...
    it('Swap transaction: clipperSwap()', async () => {
        ...
        const txConfig: Transaction = {
            nonce: 380,
            gasPrice: BigNumber.from('0x1eb1f3ba45'),
            gasLimit: BigNumber.from('0x02c6a2'),
            from: '0x3b608c5243732903152e38f1dab1056a4a79b980',
            to: '0x1111111254fb6c44bac0bed2854e76f90643097d',
            value: '0x00',
    ...
    it('Swap transaction: clipperSwapWithPermit()', async () => {
        ...
        const txConfig: Transaction = {
            nonce: 379,
            gasPrice: BigNumber.from('0x1ce84f82b4'),
            gasLimit: BigNumber.from('0x04191b'),
            from: '0x3b608c5243732903152e38f1dab1056a4a79b980',
            to: '0x1111111254fb6c44bac0bed2854e76f90643097d',
            value: '0x00',
    ...
    it('Swap transaction: unoswap()', async () => {
        ...
        const txConfig: Transaction = {
            nonce: 385,
            gasPrice: BigNumber.from('0x2620214ec7'),
            gasLimit: BigNumber.from('0x02873c'),
            from: '0x3b608c5243732903152e38f1dab1056a4a79b980',
            to: '0x1111111254fb6c44bac0bed2854e76f90643097d',
            value: '0x00',
    ...
    it('Swap transaction: unoswapWithPermit()', async () => {
        ...
        const txConfig: Transaction = {
            nonce: 381,
            gasPrice: BigNumber.from('0x1db6178ec5'),
            gasLimit: BigNumber.from('0x0343b4'),
            from: '0x3b608c5243732903152e38f1dab1056a4a79b980',
            to: '0x1111111254fb6c44bac0bed2854e76f90643097d',
            value: '0x00',
    ...
    it('Swap transaction: uniswapV3Swap()', async () => {
        ...
        const txConfig: Transaction = {
            nonce: 382,
            gasPrice: BigNumber.from('0x222511942d'),
            gasLimit: BigNumber.from('0x02696f'),
            from: '0x3b608c5243732903152e38f1dab1056a4a79b980',
            to: '0x1111111254fb6c44bac0bed2854e76f90643097d',
            value: '0x00',
